...
SimpleSystem::SimpleSystem(const char *ram_hier_path, int ram_size_words): _ram(ram_hier_path, ram_size_words, 4)
{
...
int SimpleSystem::Setup(int argc, char **argv, bool &exit_app) 
{
  ...
  simctrl.SetTop(&_top, &_top.IO_CLK, &_top.IO_RST_N, VerilatorSimCtrlFlags::ResetPolarityNegative);
